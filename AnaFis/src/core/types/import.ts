...
export interface WorkbookData {
  ...
  appVersion?: string;
  locale?: string;
  styles?: Record<string, Record<string, unknown>>; // Style definitions - flexible object structure
...
export interface CellData {
  ...
  p?: unknown; // Custom properties - keep flexible
  t?: string | number; // Cell type - can be string or number
}
