...
const UnitConversionSidebar = React.memo<UnitConversionSidebarProps>(
  ({
    ...
    const [activeUnitInput, setActiveUnitInput] = useState<
      'from' | 'to' | null
    >(null);
    const [lastFocusedUnitInput, setLastFocusedUnitInput] = useState<
      'from' | 'to'
    >('from');
    const [outputTarget, setOutputTarget] = useState<string>('');

    // Use the extracted hooks
    const { unitCategories: categories, units } = useUnitConversion({
    ...
    const { focusedInput, handleInputFocus, handleInputBlur } =
      useSpreadsheetSelection<string | null>({
        onSelectionChange: onSelectionChange ?? (() => {}),
    ...
    return (
      ...
      >
        ...
        <Box sx={sidebarStyles.header}>
          <Typography sx={sidebarStyles.text.header}>Unit Converter</Typography>
          <IconButton
            onClick={onClose}
            size="small"
        ...
        <Box sx={sidebarStyles.contentWrapper}>
          ...
          <SidebarCard title="Unit Conversion" sx={{ mx: 0.5 }}>
            ...
            <Box sx={{ mb: 1 }}>
              ...
              <Box
                sx={{ mt: 0.5, display: 'flex', flexWrap: 'wrap', gap: 0.3 }}
              >
            ...
            <Button
              ...
              variant="contained"
              startIcon={
                isConverting ? <CircularProgress size={16} /> : <ConvertIcon />
              }
          ...
          <Box>
            ...
            <SidebarCard
              variant="compact"
              title="Search Units"
              sx={{ mx: 0.5, flex: 1, minHeight: 450 }}
            >
              <TextField
                fullWidth
                size="small"
                  ...
                  return (
                    <ListItemButton
                      ...
                      onClick={() => {
                        ...
                        const targetInput =
                          activeUnitInput ?? lastFocusedUnitInput;
