...
const QuickPlotSidebar = React.memo<QuickPlotSidebarProps>(
  ({ open, onClose, spreadsheetRef, onSelectionChange }) => {
    ...
    const handleSaveToLibraryClick = () => {
      ...
      if (!xSequenceName && xLabel) {
        setXSequenceName(xLabel);
      }
      if (!ySequenceName && yLabel) {
        setYSequenceName(yLabel);
      }
    ...
    return (
      <Box sx={{ ...sidebarStyles.container, px: 1, pt: 2 }}>
        ...
        <Box sx={sidebarStyles.header}>
          <Typography sx={sidebarStyles.text.header}>Quick Plot</Typography>
          ...
          <SidebarCard title="Data Input" defaultExpanded={true}>
            ...
            <Box sx={{ mb: 2 }}>
              <FormControlLabel
                ...
                label={
                  <Typography
                    sx={{ fontSize: 11, color: 'rgba(255, 255, 255, 0.9)' }}
                  >
                    Show error bars
                  </Typography>
                }
              ...
              {showErrorBars && (
                <>
                  ...
                  >
                    ERROR BARS (±Y){' '}
                    {focusedInput === 'errorRange' && '← select range'}
                  </Typography>
                  <TextField
                    fullWidth
                    size="small"
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <FormControl>
                <RadioGroup
                  ...
                  value={plotType}
                  onChange={(e) =>
                    setPlotType(e.target.value as 'scatter' | 'line' | 'both')
                  }
                >
                  <FormControlLabel
                    value="scatter"
                ...
                {plotlyData && (
                  <Plot
                    ...
                    layout={{
                      ...
                      width: 356,
                      height: 280,
                      margin: { l: 50, r: 24, t: 28, b: 44 },
                    }}
                    config={{ responsive: false, displayModeBar: false }}
                    style={{ width: 356, height: 280, margin: '0 auto' }}
                  />
                )}
              </Box>
            </SidebarCard>
          ...
          {hasPlot && (
            <SidebarCard title="Export & Save" defaultExpanded={true}>
              ...
              >
                ...
                <DialogActions
                  sx={{ borderTop: '1px solid rgba(33, 150, 243, 0.2)', p: 2 }}
                >
                  <Button
                    onClick={() => setSaveDialogOpen(false)}
                    sx={{
                      ...sidebarStyles.button.secondary,
