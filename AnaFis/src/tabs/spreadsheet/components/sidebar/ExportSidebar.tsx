    ...
    return (
      ...
      >
        ...
        <Box sx={sidebarStyles.header}>
          <Typography sx={sidebarStyles.text.header}>Export Data</Typography>
        ...
        <Box sx={sidebarStyles.contentWrapper}>
          ...
          <SidebarCard title="Export Mode" defaultExpanded={true}>
            <FormControl fullWidth>
              <RadioGroup
                value={exportMode}
                onChange={(e) =>
                  setExportMode(e.target.value as 'file' | 'library')
                }
                row
              >
                <FormControlLabel
            ...
            <SidebarCard title="Export Configuration" defaultExpanded={true}>
              ...
              {exportFormat === 'anafispread' ? (
                ...
                >
                  ...
                  >
                    The .anafispread format exports the complete workbook
                    including:
                  </Typography>
                  <Box
                    component="ul"
                ...
                <>
                  ...
                  <FormControl component="fieldset" fullWidth sx={{ mb: 3 }}>
                    ...
                    <RadioGroup
                      value={rangeMode}
                      onChange={(e) =>
                        setRangeMode(e.target.value as ExportRangeMode)
                      }
                    >
                      <FormControlLabel
                        value="sheet"
          ...
          {exportMode === 'library' && (
            <SidebarCard
              title="Data Library Configuration"
            ...
            >
              ...
              <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setUncertaintyRange(e.target.value.toUpperCase())
                  }
              ...
              >
                ...
                (entire row 1), A1:A100 (specific range)
              </Typography>

              <Typography
                sx={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: 12, mb: 2 }}
              >
                Only numeric values from the specified ranges will be saved to
                the library.
              </Typography>
            </SidebarCard>
          )}
          ...
          <SidebarCard title="Export Actions" defaultExpanded={true}>
            ...
            {exportMode === 'file' ? (
              <Button
                ...
                disabled={
                  isExporting || (rangeMode === 'custom' && !customRange)
                }
              ...
              <Button
                ...
                disabled={
                  isExporting || !libraryName.trim() || !dataRange.trim()
                }
                sx={sidebarStyles.button.primary}
              >
