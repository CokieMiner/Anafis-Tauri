...
const UncertaintySidebar = React.memo<UncertaintySidebarProps>(
  ({
    ...
    const { handleInputFocus, handleInputBlur } =
      ...
      >
        ...
        >
          ...
          >
            ...
            {currentVariable && (
              <SidebarCard
                title={`Variable ${currentVariable.name}`}
                sx={{ mx: 0.5 }}
              >
                <Box
                  sx={{
                ...
                >
                  ...
                  >
                    ...
                    <TextField
                      ...
                      onChange={(e) =>
                        updateVariable(selectedVariable, 'name', e.target.value)
                      }
                      size="small"
                      placeholder="a"
                      sx={{
            ...
            <SidebarCard title="Output" sx={{ mx: 0.5 }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                ...
                <TextField
                  ...
                  onFocus={() =>
                    handleInputFocus({ type: 'outputUncertaintyRange' })
                  }
                  onBlur={handleInputBlur}
              ...
              {error && (
                ...
                >
                  <Typography
                    sx={{ ...sidebarStyles.text.caption, color: '#f44336' }}
                  >
                    {error}
                  </Typography>
                </Box>
