...
impl TimeSeriesDecompositionEngine {
    ...
    pub fn trend_test(data: &[f64]) -> Result<TrendAnalysis, String> {
        ...
        let p_value = 2.0 * (1.0 - crate::scientific::statistics::distributions::distribution_functions::student_t_cdf(t_statistic.abs(), 0.0, 1.0, n - 2.0));
    ...
    pub fn autocorrelation(data: &[f64], max_lag: usize) -> Result<Vec<f64>, String> {
        ...
        crate::scientific::statistics::correlation::CorrelationMethods::autocorrelation(data, max_lag)
    }
